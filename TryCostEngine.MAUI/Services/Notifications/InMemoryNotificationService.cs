...
using TryCostEngine.MAUI.NotificationContent;

namespace TryCostEngine.MAUI.Services.Notifications;
...
public class InMemoryNotificationService : INotificationService
{
    ...
    public void Preload()
    {
        _messages.Add(new NotificationMessage(
            ...
            "_content/TryCostEngine.MAUI/images/announcements/mudblazor_heretostay.png",
            new[]
            {
