...
public partial class SectionContent
{
    ...
    protected string InnerClassname =>
        new CssBuilder("docs-section-content-inner")
            ...
            .AddClass("pa-4", !_hasCode)
            .AddClass("px-4 pb-4 pt-2", _hasCode)
            .Build();

    protected string InnerNotClassname =>
      new CssBuilder("docs-section-content-inner")
          .AddClass($"relative d-flex flex-grow-1 flex-wrap justify-center align-center", !Block)
          .AddClass($"d-block mx-auto", Block)
          .AddClass($"mud-width-full", Block && FullWidth)
    ...
    [Parameter] public bool NotPad { get; set; }
    ...
    protected virtual  void RunOnTryMudBlazor()
    {
        //string firstFile = "";
        ...
        //// Data models
        //if (codeFiles.Contains("MudBlazor.CostEngine.Data.Models"))
        //{
